...
\begin{figure}[!htb]
  \begin{centering}
    ...
    \begin{picture}(20.0,26.0)
      \centerline{\includegraphics[height=24.0cm]{vtxHitmaps-RUNNUMBER.pdf}}
    \end{picture}
...
\begin{figure}[!htb]
  \begin{centering}
    \unitlength1.0cm % coordinates in cm
    \begin{picture}(20.0,26.0)
      \centerline{\includegraphics[height=24.0cm]{vtxHitToTs-RUNNUMBER.pdf}}
    \end{picture}
...
\begin{figure}[!htb]
  \begin{centering}
    \unitlength1.0cm % coordinates in cm
    \begin{picture}(20.0,26.0)
      \centerline{\includegraphics[height=24.0cm]{vtxTimeCorrelations-RUNNUMBER.pdf}}
    \end{picture}
...
\begin{figure}[!htb]
  \begin{centering}
    ...
    \begin{picture}(18.0,10.0)
      \centerline{\includegraphics[height=8.0cm]{fibers-RUNNUMBER.pdf}}
    \end{picture}
...
\begin{figure}[!htb]
  \begin{centering}
    ...
    \begin{picture}(18.0,15.0)
      \centerline{\includegraphics[height=15.0cm]{tileHitmapZphi-RUNNUMBER.pdf}}
    \end{picture}
...
\begin{figure}[!htb]
  \begin{centering}
    \unitlength1.0cm % coordinates in cm
    \begin{picture}(20.0,26.0)
      \centerline{\includegraphics[height=24.0cm]{tileASICEnergy-RUNNUMBER.pdf}}
    \end{picture}
