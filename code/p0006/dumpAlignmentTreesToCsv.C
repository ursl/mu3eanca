...
// ----------------------------------------------------------------------
void writeSensors(string filename = "sensors.csv", bool modify = false) {
...
void writeAll(string mode = "mcideal_v5.0", string filename = "nada") {
  if (string::npos != mode.find("mcideal_v5.0") && (string::npos != filename.find("nada"))) {
    ...
    cout << "we trust that you properly specified tag and directory" << endl;
  } 
