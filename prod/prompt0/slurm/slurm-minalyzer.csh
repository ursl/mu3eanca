...
echo "====================================================="
echo "====> SLURM RUN2026 prompt0 wrapper             <===="
echo "====================================================="
date
...
echo "_build/analyzer/minalyzer $ANLZR $DATADIR/$MIDASFILE  -- offline --config=config/prompt.json --cdb.dbconn=http://mu3edb0/cdb/ --cdb.gt=$GT"
_build/analyzer/minalyzer $ANLZR $DATADIR/$MIDASFILE  -- offline --config=config/prompt.json --cdb.dbconn=http://mu3edb0/cdb/ --cdb.gt=$GT
