...
class skimMu3e {
public:
  skimMu3e(TChain *tree, std::string para);
  virtual ~skimMu3e();
...
protected:
  ...
  int          fNentries;      // number of events in chain; filled in skimMu3e::skimMu3e()
  int          fChainEvent;    // current sequential event number in chain; filled in skimMu3e::loop()
  int          fEvt;           // current event number; filled in derived classes in skimMu3e::loop()
  int          fRun;           // current run number; filled in derived classes in skimMu3e::loop()
